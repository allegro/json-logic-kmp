    ...
    context("JsonLogic evaluation with NotStrictEquals operation") {
        testWithInputData(
            ...
            data = listOf(
                ...
                TestInput(expression = mapOf("!==" to listOf(-1, false)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!==" to listOf(0, false)), resultValue = JsonLogicResult.Success(true)),
                ...
                TestInput(expression = mapOf("!==" to listOf(null)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!==" to null), resultValue = JsonLogicResult.Success(true)),
