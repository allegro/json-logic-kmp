    ...
    context("JsonLogic evaluation with NotEquals operation") {
        testWithInputData(
            ...
            data = listOf(
                ...
                TestInput(expression = mapOf("!=" to listOf(1, "1")), resultValue = JsonLogicResult.Success(false)),
                TestInput(expression = mapOf("!=" to listOf(1, 2)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(null, 2)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(null, true)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(null, false)), resultValue = JsonLogicResult.Success(true)),
                TestInput(
                ...
                TestInput(expression = mapOf("!=" to listOf(1, null)), resultValue = JsonLogicResult.Success(true)),
                TestInput(
                ...
                TestInput(expression = mapOf("!=" to listOf(true, false)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(false, true)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(true, true)), resultValue = JsonLogicResult.Success(false)),
                TestInput(
                ...
                TestInput(expression = mapOf("!=" to listOf(1, false)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(-1, false)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(0, false)), resultValue = JsonLogicResult.Success(false)),
                TestInput(expression = mapOf("!=" to listOf(0, true)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(1, true)), resultValue = JsonLogicResult.Success(false)),
                TestInput(expression = mapOf("!=" to listOf(-1, true)), resultValue = JsonLogicResult.Success(true)),
                TestInput(
                    expression = mapOf("!=" to listOf(true, true, false)),
                    resultValue = JsonLogicResult.Success(false)
                ),
                TestInput(expression = mapOf("!=" to listOf(1, 0, 1)), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf(1)), resultValue = JsonLogicResult.Success(true)),
                ...
                TestInput(expression = mapOf("!=" to listOf("true")), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to listOf("banana")), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to "banana"), resultValue = JsonLogicResult.Success(true)),
                ...
                TestInput(expression = mapOf("!=" to ""), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to "     "), resultValue = JsonLogicResult.Success(true)),
                TestInput(expression = mapOf("!=" to emptyList<Any>()), resultValue = JsonLogicResult.Success(false)),
                TestInput(
