...
class EncodeTest: FunSpec({
    ...
    withData(
        ...
        ts = listOf(
            TestInput(
                expression = mapOf(
                    operatorName to listOf("https://test.pl?=1234&4321")
                ),
                result = JsonLogicResult.Success("https%3A%2F%2Ftest.pl%3F%3D1234%264321")
            ),
            TestInput(
                expression = mapOf(
            ...
            TestInput(
                ...
                result = JsonLogicResult.Success(
                    "https%3A%2F%2Ftest.pl%3Fname%3D%25C5%25BC%25C3%25B3%25C5%2582%25C4%2585d%25C5%25BA"
                )
            ),
            TestInput(
                expression = mapOf(
