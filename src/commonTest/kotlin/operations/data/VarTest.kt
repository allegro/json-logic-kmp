...
class VarTest : LogicOperationTest(
    ...
    successResultTestInput = listOf(
        ...
        Successful(expression = mapOf("var" to "a.b"), data = mapOf("a" to mapOf("b" to "c")), resultValue = "c"),
        Successful(
        ...
        Successful(expression = mapOf("var" to ""), data = listOf(1, 2, 3, 4), resultValue = listOf(1, 2, 3, 4)),
        Successful(
            expression = mapOf("var" to emptyList<Any>()),
            data = listOf(1, 2, 3, 4),
            resultValue = listOf(1, 2, 3, 4)
        ),
        Successful(expression = mapOf("var" to null), data = listOf(1, 2, 3, 4), resultValue = listOf(1, 2, 3, 4)),
        Successful(
        ...
        Successful(expression = mapOf("var" to listOf(listOf(1), 2)), data = listOf(1, 2, 3, 4), resultValue = 2),
