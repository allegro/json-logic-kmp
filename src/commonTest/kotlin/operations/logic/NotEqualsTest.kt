...
class NotEqualsTest : FunSpec({
    context("JsonLogic evaluation with only NotEquals operation") {
        withData(
            ...
            ts = listOf(
                ...
                TestInput(expression = mapOf("!=" to listOf(1, emptyList<String>())), result = true),
                TestInput(expression = mapOf("!=" to listOf("1", emptyList<String>())), result = true),
                TestInput(expression = mapOf("!=" to listOf("1.0", emptyList<String>())), result = true),
                TestInput(expression = mapOf("!=" to listOf(-1, emptyList<String>())), result = true),
                TestInput(expression = mapOf("!=" to listOf("-1", emptyList<String>())), result = true),
                TestInput(expression = mapOf("!=" to listOf("-1.0", emptyList<String>())), result = true),
                )
